...
async function seedUser () {
  try {
    ...
    userToBeInserted = {
      'password':'KQoRP4ubUCQ8aOm',
      'isDeleted':false,
      'username':'Devin66',
      'email':'Ashlynn61@yahoo.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.User
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let user = await userDb.updateOne( { 'username':'Devin66' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
    userToBeInserted = {
      'password':'0ZuMkI1Cu4z1SKa',
      'isDeleted':false,
      'username':'Candice_Shanahan',
      'email':'Anya71@gmail.com',
      'isActive':true,
      'userType':authConstant.USER_TYPES.Admin
    };
    userToBeInserted.password = await bcrypt.hash(userToBeInserted.password, 8);
    let admin = await userDb.updateOne( { 'username':'Candice_Shanahan' }, userToBeInserted,  {
      upsert: true,
      new: true
    });
